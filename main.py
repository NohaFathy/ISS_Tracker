...
screen.bgpic('C:/Users/nohaz/Downloads/world-map.png')
screen.register_shape('C:/Users/nohaz/Downloads/iss_icon.gif')

iss = turtle.Turtle()
turtle.title('ISS Tracker')
iss.shape('C:/Users/nohaz/Downloads/iss_icon.gif')
iss.penup()
